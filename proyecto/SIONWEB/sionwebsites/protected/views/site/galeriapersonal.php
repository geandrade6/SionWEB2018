...
<div style="margin-top:5%;" class="col-lg-12">
	<h1 style="text-align: center;">Galeria Personal</h1>
<script>
							...
							return b[a]};d.Qe=function(w,x,l,m,b){r=b;b=i(b,h);var j=m.Fd,f=l.Fd;j["no-image"]=!m.Lb;f["no-image"]=!l.Lb;var n=j,p=f,u=b,e=b.gc||i({},h);if(!b.r){n=f;p=j}var t=e.Rb||0;g=new o(k,p,e,c.max(t-e.hb,0),s,q);a=new o(k,n,u,c.max(e.hb-t,0),s,q);g.Zb(0);a.Zb(0);v=c.max(g.Sc,a.Sc);d.pb=w};d.Cb=function(){k.Cb();g=j;a=j};d.Le=function(){var b=j;
								...
								return b};if(b.rb()||b.od()||z&&b.ye()<537)h=16;n.call(d);m.call(d,-1e7,1e7)},i=function(p,fc){var d=this;function Bc(){var a=this;m.call(a,-1e8,2e8);a.af=function(){var b=a.Gb(),d=c.floor(b),f=t(d),e=b-c.floor(b);
									return{pb:f,cf:d,Eb:e}};a.Mb=function(b,a){var f=c.floor(a);
										if(f!=a&&a>b)f++;Tb(f,e);d.o(i.tf,t(a),t(b),a,b)}}function Ac(){var a=this;m.call(a,0,0,{sd:q});b.j(C,function(b){D&1&&b.Wd(q);a.oc(b);b.Rb(kb/bc)})}
function zc(){var a=this,b=Ub.jb;m.call(a,-1,2,{i:f.Ad,Xd:{Eb:Zb},sd:q},b,{Eb:1},{Eb:-2});a.Ob=b}
...
function oc(){var c=this,a=Xb();b.Q(a,0);b.ib(a,"pointerEvents","none");c.jb=a;c.Ce=function(c){b.L(a,c);b.G(a)};c.Cb=function(){b.U(a);b.ic(a)}}function xc(o,g){var f=this,r,L,v,k,y=[],x,B,W,G,Q,F,h,w,p;m.call(f,-u,u+1,{});
function E(a){r&&r.Ed();T(o,a,0);F=e;r=new I.T(o,I,b.Ld(b.p(o,"idle"))||lc);r.bb(0)}
function Z(){r.dc<I.dc&&E()}function M(p,r,o){if(!G){G=e;if(k&&o){var h=o.width,c=o.height,n=h,m=c;if(h&&c&&a.Db){
...
function bb(b){
				if(b==R&&s==g){
					if(!h){var a=j;
						if(A)
							if(A.pb==g)a=A.Le();
						else A.Cb();Z();h=new vc(o,g,a,r);h.Hd(p)}!h.zd()&&h.Cc()}}
function S(d,e,l){
				if(d==g){
					if(d!=e)C[e]&&C[e].pf();
						else!l&&h&&h.wf();p&&p.ad();var m=R=b.Y();f.Ib(b.W(j,bb,m))}
						else{var k=c.min(g,d),i=c.max(g,d),o=c.min(i-k,k+q-i),n=u+a.Ae-1;(!Q||o<=n)&&f.Ib()}}
function db(){
				if(s==g&&h){h.wb();p&&p.Fe();p&&p.He();h.Cd()}}
function eb(){s==g&&h&&h.wb()}function ab(a){!P&&d.o(i.Oe,g,a)}function O(){p=w.pInstance;h&&h.Hd(p)}f.Ib=function(c,a){a=a||v;
				if(y.length&&!G){b.G(a);if(!W){W=e;d.o(i.bf,g);b.j(y,function(a){if(!b.N(a,"src")){a.src=b.p(a,"src2");b.lb(a,a["display-origin"])}})}b.Od(y,k,b.W(j,M,c,a))}else M(c,a)};f.we=function(){var h=g;
									...
									if(d!=g){if(A){var e=A.De(q);if(e){var i=R=b.Y(),f=C[t(d)];
										return f.Ib(b.W(j,Y,d,f,e,i),v)}}cb(d)}};f.pc=function(){S(g,g,e)};f.pf=function(){p&&p.Fe();p&&p.He();f.Vc();h&&h.Ye();h=j;E()};f.Td=function(){b.U(o)};f.Vc=function(){b.G(o)};f.Xe=function(){p&&p.ad()};
function T(a,c,d){if(b.N(a,"jssor-slider"))return;
...
function jc(c){if(P){b.Ke(c);var a=b.fc(c);while(a&&v!==a){a.tagName=="A"&&b.Xb(c);try{a=a.parentNode}catch(d){break}}}}
function Jb(a){C[s];s=t(a);tb=C[s];Tb(a);return s}
...
function ic(){V={db:K,nb:J,f:0,e:0};b.j(T,function(a){b.M(a,V);b.F(a,"absolute");b.sb(a,"hidden");b.U(a)});b.M(gb,V)}
function ab(b,a){cb(b,a,e)}
...
function a(){var b=f.jb.parentNode.clientWidth;if(b){b=c.min(b,800);f.Qd(b)}
				else h.setTimeout(a,30)}a();b.g(h,"load",a);b.g(h,"resize",a);b.g(h,"orientationchange",a)}})(window,document,Math,null,true,false)
</script>		
				<!--Altura de caja del slider-->
				<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 500px; overflow: hidden; visibility: hidden; background-color: #24262e; border: 2px solid #3683d9; border-radius: 5px;"><!-- Loading Screen -->
				...
				<!--Altura de fotos internas del slider-->
				...
				<h1 style=" text-align: center;"> Fotos</h1>
					...
					<br>
					<div class="col-lg-4">
						<img style="width: 100%; height: 200px;border: 2px solid #fb7204;" src="<?php echo Yii::app()->request->baseUrl; ?>/img/imagen/18.jpg">
						<label>parqueos</label>
					</div>
					<div class="col-lg-4">
						<img style="width: 100%; height: 200px;border: 2px solid #3683d9;" src="<?php echo Yii::app()->request->baseUrl; ?>/img/imagen/18.jpg">
						<label>parqueos</label>
					</div>
					<div class="col-lg-4">
						<img style="width: 100%; height: 200px;border: 2px solid #fb7204;" src="<?php echo Yii::app()->request->baseUrl; ?>/img/imagen/18.jpg">
