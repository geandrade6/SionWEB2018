...
<div id="wrapper">
	<div id="main">
		<div class="inner">
            ...
            <h1>Ingrese sus Requerimientos (PQRS)</h1>
            <form action="">
            <div>
            <br>
            <label for="">Codigo Automatico de su requerimiento</label>
            <input type="text" readonly>
            </div>
            <div>
            <br>
            <label for="">Digite el Asunto correspondiente</label>
            <input type="text" placeholder="Digitar su titulo u objetivo del mensaje">
            </div>
            <div>
            <br>
            <label >Digite el mensaje deacuerdo a su solicitud</label>
