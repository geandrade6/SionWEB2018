    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' action
             ...
             array('deny', // deny all users
                'actions' => array('consultaclientes','consultaclientesdos','consultapartamento','consultavehiculosdos','sorteo','pqrs','limpiarSorteo','generarSorteo','guardarSorteo','pqrsadmin','versorteos','consultapart','insertareventos','gestionusuarios','gestionvehiculos','consultavehiculos','informes','consultaporfecha','consultaplaca','consultacedulas','consultaporfechados','consultatipos','controldeacceso','consultacontrol'),
